...
ALIEN_IMAGES = ('TIE_1.png', 'TIE_2.png', 'TIE_3.png')
...
BOLT_RATE   = 5
# the fire button for the player's ship
BOLT_BUTTON = 'spacebar'
...
Python puts ['invaders.py', '3', '4', '0.5'] into sys.argv. Below, we take advantage of 
